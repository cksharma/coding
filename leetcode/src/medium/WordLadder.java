...
public class WordLadder {
	...
	public static void main(String[] args) {
		...
		sol = new WordLadder();
		dict = new HashSet <>(Arrays.asList("a","b","c"));
		System.out.println(sol.ladderLength("a", "c", dict));
		...
		System.out.println(sol.ladderLength("cet", "ism", dict));  
		
		sol = new WordLadder();
		dict = new HashSet <> (Arrays.asList("si","go","se","cm","so","ph","mt","db","mb","sb","kr","ln","tm","le","av","sm","ar","ci","ca","br","ti","ba","to","ra","fa","yo","ow","sn","ya","cr","po","fe","ho","ma","re","or","rn","au","ur","rh","sr","tc","lt","lo","as","fr","nb","yb","if","pb","ge","th","pm","rb","sh","co","ga","li","ha","hz","no","bi","di","hi","qa","pi","os","uh","wm","an","me","mo","na","la","st","er","sc","ne","mn","mi","am","ex","pt","inputoutput","be","fm","ta","tb","ni","mr","pa","he","lr","sq","ye"));
		System.out.println(sol.ladderLength("qa", "sq", dict)); 
	}
}
