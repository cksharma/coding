...
public class MinimumHeightTrees {
    ...
    public List<Integer> findMinHeightTrees(int n, int[][] edges) {
        ...
        for (int i = 0; i < edges.length; i++) {
            ...
            List<Integer> edgeList = adj.get(x);
            if (edgeList == null) edgeList = new ArrayList<>();
            edgeList.add(y);

            List<Integer> edgeList1 = adj.get(y);
            if (edgeList1 == null) edgeList1 = new ArrayList<>();
            edgeList1.add(x);
        ...
        for (int i : adj.keySet()) {
            ...
            while (queue.size() > 0) {
                ...
                thisLevel = Math.max(thisLevel, level);


                if (level > maxLevel) break;

                List<Integer> neighbourList = adj.get(num);

                if (neighbourList == null) continue;

                for (int item : neighbourList) {
                    State st = new State(item, level + 1);
            ...
            //System.out.println("i:" + i + " height:" + level);
