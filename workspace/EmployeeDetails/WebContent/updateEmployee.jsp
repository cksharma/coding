...
<pre>
<h1><font color = "green">Employee's Details Updated</font></h1>
<br>
<h2>Employee Id    : ${update.employeeId} </h2> 
<h2>Employee Name  : ${update.employeeName} </h2>
<h2>Designation    : ${update.designation}</h2>
<h2>Salary         : ${update.salary}</h2>

</pre>
</td>
</tr>
<a href = "updateemployee.html">Update More Employee</a>
<tr>
